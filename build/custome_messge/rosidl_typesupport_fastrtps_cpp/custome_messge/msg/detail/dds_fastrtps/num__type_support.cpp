...
#include "custome_messge/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custome_messge::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custome_messge::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custome_messge::msg::Num *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custome_messge
const rosidl_message_type_support_t *
get_message_type_support_handle<custome_messge::msg::Num>()
{
  return &custome_messge::msg::typesupport_fastrtps_cpp::_Num__handle;
}
