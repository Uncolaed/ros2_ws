...
#include "interface/msg/detail/temprature__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::msg::Temprature & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::msg::Temprature & ros_message)
{
  // Member: sensor_name
  cdr >> ros_message.sensor_name;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
max_serialized_size_Temprature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface::msg::Temprature;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface::msg::Temprature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::msg::Temprature *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Temprature__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interface::msg::Temprature *>(
...
static size_t _Temprature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Temprature(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Temprature__callbacks = {
  "interface::msg",
  "Temprature",
...
static rosidl_message_type_support_t _Temprature__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Temprature__callbacks,
...
{
  return &interface::msg::typesupport_fastrtps_cpp::_Temprature__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, Temprature)() {
  return &interface::msg::typesupport_fastrtps_cpp::_Temprature__handle;
}
