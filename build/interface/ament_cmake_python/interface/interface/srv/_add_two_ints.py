    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interface.srv.AddTwoInts_Request')
            logger.debug(
...
class Metaclass_AddTwoInts_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interface.srv.AddTwoInts_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interface.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from interface.srv._add_two_ints import AddTwoInts_Request as Request
    from interface.srv._add_two_ints import AddTwoInts_Response as Response
