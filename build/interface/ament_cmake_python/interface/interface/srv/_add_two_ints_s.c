...
bool interface__srv__add_two_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.srv._add_two_ints.AddTwoInts_Request", full_classname_dest, 46) == 0);
  }
  interface__srv__AddTwoInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * interface__srv__add_two_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface.srv._add_two_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool interface__srv__add_two_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.srv._add_two_ints.AddTwoInts_Response", full_classname_dest, 47) == 0);
  }
  interface__srv__AddTwoInts_Response * ros_message = _ros_message;
  {  // sum
