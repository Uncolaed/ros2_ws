...
{
  new (message_memory) custome_messge::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custome_messge::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[3] = {
  {
    ...
    offsetof(custome_messge::msg::Num, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custome_messge::msg::Num, num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custome_messge::msg::Num, mark),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  "custome_messge::msg",  // message namespace
  "Num",  // message name
  3,  // number of fields
  sizeof(custome_messge::msg::Num),
...
get_message_type_support_handle<custome_messge::msg::Num>()
{
  return &::custome_messge::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custome_messge, msg, Num)() {
  return &::custome_messge::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
