...
bool custome_messge__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custome_messge.msg._num.Num", full_classname_dest, 27) == 0);
  }
  custome_messge__msg__Num * ros_message = _ros_message;
  {  // name
  ...
  {  // mark
    PyObject * field = PyObject_GetAttrString(_pymsg, "mark");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->mark, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * custome_messge__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custome_messge.msg._num");
  ...
  {  // mark
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->mark.data,
      strlen(ros_message->mark.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "mark", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
